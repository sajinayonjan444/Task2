  ...
  return (
    <div>
      {orientation === "horizontal" ? (
       ...
       <div className={`w-full max-w-xl lg:h-124  rounded-3xl p-10 ${bgcolor} ${textcolor}  `}>
        <div className="flex flex-col relative -rotate-90 top-9-left-20 ">
          <div className="text-4xl pt-3 font-bold">
            {title}
          </div>
